...
namespace MCS_POS.Kasir
{
    public partial class PrinterSettingForm : Form
    {
        ...
        private void PrinterSettingForm_Load(object sender, EventArgs e)
        {
            ...
            {
                PrinterComboBox.SelectedItem = Properties.Settings.Default.PrinterName;
            }
            ...
            // Load setting
            SpasiComboBox.SelectedItem = Properties.Settings.Default.PrinterSpace.ToString();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                defaultSetting.PrinterName = PrinterComboBox.SelectedItem.ToString();
            }

            // set properties spasi
            defaultSetting.PrinterSpace = int.Parse(SpasiComboBox.SelectedItem.ToString());
